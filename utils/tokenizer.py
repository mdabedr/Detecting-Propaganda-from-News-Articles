...
class GloveTokenizer(Tokenizer):
    ...
    def build_tokenizer(self,  sent_list, vocab_size=50000, need_split=True):
        # build vocab
        from utils.build_vocab import build_vocab
        word2id, id2word, vocab_size = build_vocab(sent_list, vocab_size, fill_vocab=False, need_split=need_split)
